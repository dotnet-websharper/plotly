...
module ScatterModule =
    ...
    let ScatterProjectionXYZ =
        Pattern.Config "ScatterProjectionXYZ" {
            Required = []
            Optional = [
                "show", T<bool>
                "opacity", T<float>
    ...
    let ScatterProjection =
        Pattern.Config "ScatterProjection" {
            Required = []
            Optional = [
                "x", ScatterProjectionXYZ.Type
                "y", ScatterProjectionXYZ.Type
                "z", ScatterProjectionXYZ.Type
            ]
        }

    let ScatterSurfaceAxis =
        Pattern.EnumStrings "ScatterSurfaceAxis" [
            "-1"
            "0"
            "1"
            "2"
